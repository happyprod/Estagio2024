...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3"
        ...
        <div class="collapse navbar-collapse w-auto h-100 " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="./registarevento.php">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Registar Evento</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">Registar Evento</h6>
                </nav>
        ...
        <div class="border-top my-1 w-80 mx-auto">
    <div class="row mt-5">
        <div class="col-12 col-xl-12">
            <div class="card h-100 p-3">
                <form action="processa_formulario.php" method="post" enctype="multipart/form-data">
                    ...
                    <input class="form-control mb-4" type="text" id="titulo" name="titulo" required>

                    <label for="preco" class="form-control-label">Preço</label>
                    <input class="form-control mb-4" type="text" id="preco" name="preco" required>

                    <label for="localizacao" class="form-control-label">Localização</label>
                    <input class="form-control mb-4" type="text" id="localizacao" name="localizacao" required>

                    <label for="sinopse" class="form-control-label">Sinopse</label>
                    <textarea class="form-control mb-4" id="sinopse" name="sinopse" rows="3" required></textarea>

                    <label for="descricao" class="form-control-label">Descrição</label>
                    <textarea class="form-control mb-4" id="descricao" name="descricao" rows="6" required></textarea>

                    <div class="form-group">
                        <label for="cartaz">Cartaz</label>
                        <input type="file" class="form-control-file" id="cartaz" name="cartaz">
                    </div>
        ...
        $('#eventForm').submit(function(event) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    // Tratar a resposta do servidor (exibir mensagem de sucesso)
                    console.log(response);
                    alert('Evento inserido com sucesso!');
                    // Redirecionar ou realizar outra ação após o sucesso
                },
                error: function(error) {
                    // Tratar erros de requisição (exibir mensagem de erro)
                    console.error(error);

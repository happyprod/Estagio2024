...
<body class="g-sidenav-show  bg-gray-100">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="./pages/profile.html">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center text-white ni ni-cart">
                        </div>
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Carrinho</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">Carrinho</h6>
                </nav>
        ...
        <div class="container-fluid mt-0 py-1 d-flex align-items-center justify-content-center">
            <div class="page-header min-height-200 border-radius-xl mt-4 w-75"
        ...
        // Consulta SQL para selecionar todos os registros da tabela "shows"
        $sql_infos = "SELECT * FROM shows";
        ...
        if ($result_infos->num_rows > 0) {
            ...
            while ($row_infos = $result_infos->fetch_assoc()) {
                // Adicionar o registro atual ao array de registros
                $registros[] = $row_infos;
            }

            // Agora $registros contém todos os registros da tabela "shows"
            // Você pode percorrer $registros para acessar cada registro
            foreach ($registros as $registro) {
                $sinopse = $registro["sinopse"];
                $descricao = $registro["descricao"];
                $cartaz = $registro["cartaz"];
                $titulo = $registro["titulo"];
                $localizacao = $registro["localizacao"];
                $preco = $registro["preco"];
                $id_cartaz = $registro["id"];
            ...
            <div class="row">  
                ...
                <div class="col-lg-4">
                    <div class="w-100 mb-5 mt-5">
                        <div class="card">
                            <div class="col-lg-12 ms-auto text-center mt-3">
                                <div class="border-radius-lg h-100">
                                    <div
                                        class="position-relative d-flex align-items-center justify-content-center h-100">
                                        <img class="w-100 position-relative z-index-2 pt-1" style="width: 310px; height: 225px;"
                                        src="./img/cartaz/' . $cartaz . '" alt="' . $titulo . ' Cartaz">
                                    </div>
                                </div>
                            </div>
                            <div class="card-body p-3">
                                <div class="d-flex flex-column h-100">
                                    <p class="mb-1 pt-2 text-bold">' . $localizacao . '</p>
                                    <h5 class="font-weight-bolder">'  . $titulo . '</h5>
                                    <p class="mb-5" style="height: 78px;">' . $sinopse .  '</p>
                                    <a class="text-body text-sm font-weight-bold mb-0 icon-move-right mt-auto"
                                        href="./cartazes/'. $id_cartaz .'.php">
                                        Ver Mais
            ...
            echo "Nenhum registro encontrado na tabela 'shows'.";
        }
        ...
        ?>
            ...
            <div class="w-90 mb-5 mt-5 d-flex justify-content-center mx-auto">
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="d-flex flex-column h-90 p-go-to-feed">
                                    <h2 class="">Feed</h2>
                                    <p class="mb-5 text-justified">Esteja sempre a par de todas as novidades das pessoas
                                        que
                                        estão no seu
                                        radar. <br> Sempre que alguém que você siga publicar algo novo como um show ou
                                        uma
                                        publicação normal

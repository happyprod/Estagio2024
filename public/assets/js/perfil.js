                    ...
                    <li class="list-group-item pt-0 pb-3">
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0 me-3">
                                <img src="http://localhost/ConcertPulse/public/users/${response.id}/${response.picture}" alt="" class="avatar rounded-circle img-fluid my-auto" style="object-fit: cover; width: 45px; height: 45px;">
                            </div>

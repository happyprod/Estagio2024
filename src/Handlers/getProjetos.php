...
<!-- Main Carousel -->
<div id="carousel' . $count . '" class="carousel slide w-100 h-100" data-interval="false">
...
<img ';
    if ($google_image) {
        ...
        $html .= 'src="http://localhost/ConcertPulse/public/users/' . $p_founder . '/' . $fotodeperfil . '"';
    }
...
<a href="' . $id . '.php"><h6 class="title mb-0" style="font-size: 14px;">@' . $id_name_user . '</h6></a>';
    if ($p_userId) {
...
<div class="carousel-inner w-100 h-100">';
    ...
    if (count($result2) > 0) {  // Use PDO method to check rows
        ...
        foreach ($result2 as $row2) {
            ...
            $html .= '
<div class="carousel-item w-100 h-100 ' . ($isActive ? 'active' : '') . '">
<img src="http://localhost/ConcertPulse/public/users/' . $p_founder . '/' . $pi_imagem . '" class="d-block w-100 h-100" alt="...">
</div>';

<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3" id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="/public/home.php">
    ...
    <div class="collapse navbar-collapse w-auto" style="height: auto;" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/public/chat.php">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link <?php
                                    ...
                                    ?>" href="/public/utilizadores/<?php echo $_SESSION['user_id']; ?>.php">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            $sql = "SELECT identity FROM accounts WHERE id = :id";
            $stmt = $conn->prepare($sql);
            $stmt->bindParam(":id", $iddoutilizador, PDO::PARAM_INT);
            $stmt->execute();
...
';
            ...
            <li class="nav-item mt-auto d-flex">
                <a class="nav-link w-90" href="/public/loginartists.php">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <img src="/public/img/logout.png" style="width: 12px;">
                    </div>

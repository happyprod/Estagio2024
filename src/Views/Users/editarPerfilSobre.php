...
<div class="container-fluid">
    <div class="page-header min-height-300 border-radius-xl mt-4" id="cover-photo-container"
        ...
        <div class="cover-overlay w-100" onclick="uploadCoverImage()">
            <img id="nome_arquivo" src="http://localhost/redes/public/users/<?php echo $id . '/' . $fotodecapa; ?>" alt="cover_image" class="img-fluid w-100" style="height: 300px; object-fit: cover; cursor: pointer;" />
